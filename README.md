...
Проанализировав запрос к БД и предоставленные таблицы, можно заметить несоответствие. Построим ER-диаграммы для данных, которые мы хотим импортировать и для предлагаемой структуры БД из запроса.
